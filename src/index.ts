...
export function buildProgram(): Command {
  ...
  program
    ...
    .option(
      '-t, --target <host>',
      'Target host: claude-code | codex | all (agy is project-scope only). '
  ...
  program
    ...
    .option('-t, --target <host>', 'Target host: claude-code | codex | all (agy: --scope project)')
    .option('--scope <scope>', 'Install scope: global | project', 'global')
    .option('--project', 'Alias for --scope project')
  ...
  program
    ...
    .requiredOption(
      '-t, --target <host>',
      'Target host: claude-code | codex | all (agy: --scope project)',
    )
    .option('--scope <scope>', 'Install scope: global | project', 'global')
    .option('--project', 'Alias for --scope project')
    .action(async (opts: { target: string; scope: string; project?: boolean }) => {
