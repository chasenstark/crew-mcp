...
//
// The GenericAdapter is a leaf-agent adapter; it is not a captain adapter.
// This test documents the invariant so that future changes which try to
// route captain work through a generic agent fail loudly with a readable
// error.
